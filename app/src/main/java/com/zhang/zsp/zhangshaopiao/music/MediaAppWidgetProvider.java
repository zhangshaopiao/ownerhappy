...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        ...
        if (playing) {
            views.setImageViewResource(R.id.control_play, R.mipmap.ic_appwidget_music_pause);
        } else {
            views.setImageViewResource(R.id.control_play, R.mipmap.ic_appwidget_music_play);
        }
