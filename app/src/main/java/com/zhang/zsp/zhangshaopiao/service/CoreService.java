package com.zhang.zsp.zhangshaopiao.service;
...
import com.zhang.zsp.zhangshaopiao.model.app.AndroidAppProcess;
import com.zhang.zsp.zhangshaopiao.model.app.ProcessManager;
    ...
    private class TaskScan extends AsyncTask<Void, Integer, List<AppProcessInfo>> {
        ...
        protected List<AppProcessInfo> doInBackground(Void... params) {
            ...
            for (int i = 0; i< appProcessList.size();i++) {
               if(appProcessList.get(i).getPackageName().equals(getPackageName())){
            ...
            for (AndroidAppProcess appProcessInfo : appProcessList) {
                ...
                abAppProcessInfo = new AppProcessInfo(appProcessInfo.getPackageName(), appProcessInfo.pid, appProcessInfo.uid);
                try {
