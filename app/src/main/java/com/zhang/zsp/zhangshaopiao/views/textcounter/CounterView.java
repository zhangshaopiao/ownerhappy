...
import com.zhang.zsp.zhangshaopiao.views.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.zhang.zsp.zhangshaopiao.views.textcounter.formatters.DecimalFormatter;
import com.zhang.zsp.zhangshaopiao.views.textcounter.formatters.IntegerFormatter;
import com.zhang.zsp.zhangshaopiao.views.textcounter.formatters.NoFormatter;
    ...
    protected void updateCounterType() {
        switch(counterType) {
            case NUMBER:
                ...
                break;
            case DECIMAL:
                formatter = (Formatter) new DecimalFormatter();
                break;
            case BOTH:
                formatter = (Formatter) new CommaSeparatedDecimalFormatter();
                break;
        }
    }
